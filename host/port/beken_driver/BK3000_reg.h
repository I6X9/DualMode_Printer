...
#define BK3000_PCM1_BASE_ADDR             0x00F18000
#define BK3000_I2C2_BASE_ADDR             0x00F28000
#define BK3000_PCM2_BASE_ADDR             0x00F30000
...
#define BK3000_IRDA_BASE_ADDR             0x00F18000
#define BK3000_DSP_BASE_ADDR              0x00F90000
#define BK3000_SDIO_BASE_ADDR             0x00F80000
#define BK3000_CEVA_BASE_ADDR   		  0x00F70000
#define BK3000_XVR_BASE_ADDR    		  0x00F00000
#define BK3000_EFUSE_BASE_ADDR            0x00F98000


// PMU define
#define BK3000_EFUSE_CONFIG             (*((volatile unsigned int *)(BK3000_EFUSE_BASE_ADDR + 0*4)))
#define BK3000_EFUSE_READ_REG         (*((volatile unsigned int *)(BK3000_EFUSE_BASE_ADDR + 1*4)))
...
#define BK3000_PMU_DSP_CFG      (*((volatile unsigned long *)(BK3000_PMU_BASE_ADDR + 0x08*4)))
...
#define bit_PMU_I2C1_PWD                  (1<<3)
#define bit_PMU_IRDA_PWD                  (1<<4)
...
#define bit_RWBLE_CLK13M_PWD              (1<<29)
...
#define bit_ALL_IRQ_INTR         (bit_EXTERNAL_INT0|bit_EXTERNAL_INT1|bit_PT0_INTR|bit_PT1_INTR|bit_PCM_INTR|bit_I2C_INTR|bit_UART_INTR)
...
#define BK3000_GPIO_58_CONFIG                (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+58*4)))

#define BK3000_GPIO_59_CONFIG                (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+59*4)))
#define BK3000_GPIO_60_CONFIG                (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+60*4)))
#define BK3000_GPIO_61_CONFIG                (*((volatile unsigned long *)(BK3000_GPIO_BASE_ADDR+61*4)))
...
/* For power down or system reset flag check 
    bit0:      reserved;
    bit1-15:   to be used
    bit16:     trigger bit;
    bit17-31:  reserved;
*/
/* For Example */
#define PWR_DOWN_FLAG_CHG_FINISHED_WITH_RTC         (1 << 1)
#define PWR_DOWN_FLAG_CHG_FINISHED                  (1 << 2)
#define PWR_DOWN_FLAG_BY_BUTTON                     (1 << 3)
#define PWR_DOWN_FLAG_BY_WATCHDOG                   (1 << 4)
#define PWR_DOWN_FLAG_BY_SYS_START                  (1 << 5)
#define PWR_DOWN_FLAG_BY_TIMEROUT                   (1 << 6)
#define PWR_ON_SYS_BOOTING                          (1 << 7)

#define USB_IS_PLUG_IN            					(BK3000_GPIO_DRB & (1 << 1))
#define CHECK_PWR_DOWN_FLAG(bits)                   (BK3000_AF_CONFIG & bits)
#define CLEAR_PWR_DOWN_FLAG(bits)                   do{ BK3000_AE_CONFIG &= ~bits;BK3000_AE_CONFIG &= ~(1<<16);BK3000_AE_CONFIG |= (1<<16);}while(0)
#define SET_PWR_DOWN_FLAG(bits)                     do{ BK3000_AE_CONFIG |= bits; BK3000_AE_CONFIG &= ~(1<<16);BK3000_AE_CONFIG |= (1<<16);}while(0)

/* for software define register GPIO_3D
    BIT0 : system is booting;
    BIT1 : DSP restarting;
    ...
*/
#define SYS_MCU_PWR_ON_BOOTING                       (1 << 0)
#define SYS_DSP_RESTARTING                           (1 << 1)

#define SET_SW_REGISTER(bits)                       do{ BK3000_AD_CONFIG |= bits;}while(0)                       
#define CHECK_SW_REGISTER(bits)                     (BK3000_AD_CONFIG & bits)
#define CLEAR_SW_REGISTER(bits)                     do{ BK3000_AD_CONFIG &= ~bits;}while(0)
...
// DSP
#define BK3000_DSP_CONFIG              (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+0*4))
#define sft_DSP_RESET                   BIT_0
#define sft_DSP_ORESET                  BIT_1
#define sft_DSP_BOOT                    BIT_2
#define sft_DSP_DSP_ORESET              BIT_3
#define sft_DSP_VCNTX_EN                BIT_4
#define sft_DSP_CACHE_INV               BIT_5
#define sft_DSP_PMSS_MODE               BIT_6

#define BK3000_DSP_INTERRUPT_RECOVER   (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+1*4))
#define sft_DSP_VINT                    BIT_0
#define sft_DSP_NMI                     BIT_1
#define sft_DSP_CORE_RCVR               BIT_2

#define BK3000_DSP_VECTOR              (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+2*4)))
#define BK3000_DSP_POWER               (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+3*4)))
#define BK3000_DSP_AXI_BVALID_CTRL     (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+4*4)))
#define BK3000_DSP_TOP_ADDR0           (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+5*4)))
#define BK3000_DSP_BOTTON_ADDR0        (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+6*4)))
#define BK3000_DSP_TOP_ADDR1           (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+7*4)))
#define BK3000_DSP_BOTTON_ADDR1        (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+8*4)))
#define BK3000_DSP_TOP_ADDR2           (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+9*4)))
#define BK3000_DSP_BOTTON_ADDR2        (*((volatile unsigned int *)(BK3000_DSP_BASE_ADDR+10*4)))
...
#define UART_BAUDRATE_115200    1500000//default SPP
...
//USB register
#define REG_USB_BASE_ADDR               (0x00D04000UL)
