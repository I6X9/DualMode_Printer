...
//extern MGC_MsdCmdSet* MGC_GetSff8070iCmdSet(void);
...
static MGC_MsdDevice* MGC_MsdDeviceInit(MUSB_Device* pUsbDevice)
{
	...
	MUSB_DPRINTF1("MGC_MsdDeviceInit\r\n");
...
//	MUSB_DPRINTF("MUSB_MsdConnect Function is called\r\n");
    /* assume first config */
		    ...
		    (pIface->bNumEndpoints >= 2))
		{
		    ...
		    if(MGC_MSD_BOT_PROTOCOL == bProtocol)
		    {
				...
				case MGC_MSD_SCSI_SUBCLASS:
				    ...
				    break;
//				case MGC_MSD_SFF_8070i_SUBCLASS:
//					pCmdSet = MGC_GetSff8070iCmdSet();
//				    break;
				default:
				    continue;
				}
