...
//		MUSB_DPRINTF("before send test unit ready: bMediumchange=%d,Nomedia=%d\r\n",bMediumChange,pScsi->bNoMedium);
...
//表示U盘的容量为0,异常?????
	    ...
	    default:
		MUSB_DIAG1(1, "MSD/SCSI: Internal error; bad state ", pScsi->bState,
		    16, 2);
		return 0;
    }
