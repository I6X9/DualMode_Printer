...
#define MUSB_CLASS_GET_MAX_LUN      0xFE
...
* Vendor requests
*/
#define MUSB_VENDOR_CLEAR_FEATURE   0x01   // Code for Clear feature
...
} __PACKED_POST__ MUSB_DeviceDescriptor;
#include "mu_pkoff.h"
...
typedef struct
{
    ...
    uint8_t bmAttributes;
    uint8_t bMaxPower;
}__PACKED_POST__  MUSB_ConfigurationDescriptor;
#include "mu_pkoff.h"
