...
#ifdef CONFIG_TWS
/* Get current AG indicators status */
result_t bt_hfp_hf_cind_read(bt_hfp_hf_session_h session);
#endif
/**
...
result_t bt_hfp_hf_iphoneaccev(bt_hfp_hf_session_h session, int8 level);
