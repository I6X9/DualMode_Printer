...
#define TWS_VENDOR_DEP_SET_ABSOLUTE_VOL     0x18
#endif
...
#define AVC_OP_TWS_POWER_OFF                0x7F
#define AVC_OP_TWS_CALL                     0x7E
#define AVC_OP_TWS_CALL_END                 0x7D
#define AVC_OP_TWS_RE_SYNC             0x7C
#endif
...
#define avc_op_str(op) (                                                  \
    ...
    (op) == AVC_OP_NEXT          ? "NEXT"                                :\
    (op) == AVC_OP_PREV          ? "PREV"                                :\
    (op) == AVC_OP_MATCH          ? "MATCH"                              :\
    (op) == AVC_OP_TWS_POWER_OFF  ? "TWS_POWER_OFF"                      :\
    (op) == AVC_OP_TWS_CALL       ? "TWS_CALL"                           :\
    (op) == AVC_OP_TWS_CALL_END   ? "TWS_CALL_END"                       :\
    (op) == AVC_OP_TWS_RE_SYNC? "TWS_RE_SYNC"                       :\
    "UNKNOWN")
#else
