...
#ifdef CONFIG_TWS
void bt_unit_acl_disconnect_tws_slave(void);
void bt_unit_flush_tws_slave(void);
result_t bt_unit_set_event_filter_type(bt_unit_h unit,uint8_t *cmdbuf,uint8 len);
void unit_update_ext_inq_rsp(bt_unit_h unit);
void bt_unit_acl_disconnect_with_reason(bt_unit_h unit, const btaddr_t *raddr, uint8 const reason);
#endif
#endif
