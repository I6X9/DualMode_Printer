...
enum hci_error {
    ...
    HCI_ERR_CONNECTION_REJECTED_TWS_M_BUSY = 0xF0        //0x39
};
#ifdef CONFIG_TWS
...
#define HCI_BOTH_INQUIRY_PAGE_SCAN_ENABLE     0x03
/* 0x04 - 0xFF - reserved for future use */
...
/* Reserved                                         0x00000008 */
#define HCI_EVMSK_BEKEN_DEFINED                     0x00000010 
/* Reserved                                         0x00000020 */
/* Reserved                                         0x00000040 */
/* Reserved                                         0x00000080 */
/* Reserved                                         0x00000100 */
...
#define HCI_EVENT_BEKEN_DEFINED                  0x25
typedef   struct {
    uint8_t      status;         /* 0x00 - success */
    btaddr_t     btaddr;         /* remote device address */
} __PACKED_POST__ hci_beken_defined_ep;


/* Beken defined */
typedef   struct {
    uint16_t    pswd;           /* password */
    uint16_t    handle;     /* acl link handle */
    uint8_t     pkt_type;       /* default packet type */
    uint8_t     poll_interval;   /* poll interval */
} __PACKED_POST__ hci_write_default_pkt_type_cp;
