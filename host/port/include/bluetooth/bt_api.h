...
typedef void (*bt_beken_defined_evt_cb_t)(bt_app_ctx_h app_ctx_h,
...
typedef void (*bt_mode_change_notificaton_cb_t)(bt_app_ctx_h app_ctx_h,
    uint8_t bt_mode);
...
typedef struct bt_unit_app_cbs_s {
    ...
    bt_mode_change_notificaton_cb_t        mode_change_notification_cb;
#ifdef CONFIG_BLUETOOTH_SSP
...
#endif
    bt_beken_defined_evt_cb_t              beken_defined_evt_cb;
} bt_unit_app_cbs_t;
