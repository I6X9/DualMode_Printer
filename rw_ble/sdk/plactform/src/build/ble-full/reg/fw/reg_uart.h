 ...
 * </pre>
 */
#define UART_CONF_ADDR   0x00806300
...
#define UART_FIFO_CONF_ADDR				0x00806304
...
#define UART_FLOW_CONF_ADDR				0x00806318
 ...
 * </pre>
 */
#define UART_FIFO_STATUS_ADDR   0x00806308
 ...
 * </pre>
 */
#define UART_ISR_STAT_ADDR   0x00806314
 ...
 * </pre>
 */
#define UART_ISR_EN_ADDR   0x00806310
...
__INLINE void uart_rx_wakeup_en_setf(uint8_t wake_up)
{
    ASSERT_ERR((((uint32_t)wake_up << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_PL_WR(UART_ISR_EN_ADDR, (REG_PL_RD(UART_ISR_EN_ADDR) & ~((uint32_t)0x00000080)) | ((uint32_t)wake_up << 7));
}
