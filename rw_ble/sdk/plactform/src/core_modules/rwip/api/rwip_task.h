...
enum TASK_API_ID
{
	...
	TASK_ID_FFF0S        = 69,   // FFF0 Profile Server Task
	
	TASK_ID_FFE0S        = 70,   // FFE0 Profile Server Task
	
	TASK_ID_OTAS         = 71,   // OTAS Profile Server Task

	TASK_ID_WECHAT		 = 72,   //WECHAT profile Server Task

	TASK_ID_ANCSC        = 73,   //Ancs Client
