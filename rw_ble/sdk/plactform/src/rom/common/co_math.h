 ...
 * ****************************************************************************************
 */
#include "types.h"             // standard integer definitions
#include <stdbool.h>            // standard boolean definitions
#include <stdlib.h>             // standard lib functions
#include "compiler.h"           // compiler functions - inline
 ...
 *
 * @param val Value to count the number of leading zeros on.
 *
...
/**
 ****************************************************************************************
 * @brief Function to return the absolut value of a signed integer.
 *
