...
#define LLD_EVT_DEFAULT_RX_WIN_SIZE     (15)
/// Frame Duration
...
enum lld_evt_flag
{
    ...
    /// Flag that indicate we are waiting for first update sync
    LLD_EVT_FLAG_WAITING_UPDATE_SYNC      = (1 << 8),
};
...
struct lld_conn
{
    ...
    /// Number of connection No recived Packet since last received, Yangyang, 2018/10/17
    uint16_t no_pkt_cnt;
};
