...
#else
#define BLE_TEST_MODE_SUPPORT       (0)
#endif 
...
#define RWBLE_PROG_LATENCY_DFT         (1)   // Modified from 2 to 1, Yangyang, 2018/6/22
/// EA asap latency
...
#define BLE_CMDS_BYTE35     (  BLE_LE_RD_LOCAL_RESOLV_ADDR_CMD    \
                             ...
                             | BLE_LE_RD_PHY_CMD | BLE_LE_SET_DFT_PHY_CMD\
                             | BLE_LE_SET_PHY_CMD | BLE_LE_ENH_RX_TEST_CMD)
...
#define BLE_MAX_TIME_4_2    (2120)
#define BLE_MAX_TIME        (BLE_MAX_TIME_4_2)
#else
...
#define BLE_NB_MAX_PACKET_PROG   (10)
/******************************************************************************************/
/* --------------------------   PROCEDURE STARTUP ----------------------------------------*/
/******************************************************************************************/

#define BLE_NO_PROCEDURE    (0)
