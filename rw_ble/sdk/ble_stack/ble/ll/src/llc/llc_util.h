 ...
 ****************************************************************************************
 */
__INLINE bool llc_state_chk(ke_state_t state, uint8_t procedure)
{
 ...
 ****************************************************************************************
 */
__INLINE void llc_state_update(ke_task_id_t task, ke_state_t *state, uint8_t procedure, bool enable)
{
