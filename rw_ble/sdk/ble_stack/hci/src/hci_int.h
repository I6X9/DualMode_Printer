...
#include "types.h"          // standard integer
 ...
 *****************************************************************************************
 */
HCI_PACK_STATUS_E hci_util_pack(uint8_t* inout, uint16_t* inout_len, const char* format);
 ...
 *****************************************************************************************
 */
HCI_PACK_STATUS_E hci_util_unpack(uint8_t* out, uint8_t* in, uint16_t* out_len, uint16_t in_len, const char* format);
#endif //(HCI_TL_SUPPORT)
