...
#define BLE_OTAS_SERVER        1
#else
#define BLE_OTAS_SERVER        0
...
///FFF0 Profile Locator role
#if defined(CFG_PRF_FCC0)
#define BLE_FCC0_SERVER        1
#else
#define BLE_FCC0_SERVER        0
#endif // defined(CFG_PRF_FFC0)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
		...
		|| BLE_FFF0_SERVER || BLE_FFE0_SERVER || BLE_FCC0_SERVER)
