...
//#define VIC_I2S_ISR_INDEX             (11)
#define VIC_I2C2_ISR_INDEX            (12)
#define VIC_UART_ISR_INDEX            (13)
#define VIC_I2C1_ISR_INDEX            (11)  // VIC_SPI2_ISR_INDEX 
...
#define VIC_USB_PLUG_IN_ISR_INDEX     (21)
#define VIC_MAILBOX_ISR_INDEX         (22)
#define VIC_RWBLE_ISR_INDEX           (23)
#define VIC_PSRAM_ISR_INDEX           (24)
#define VIC_UART2_ISR_INDEX           (25)
/* software define this timer interrupt,interval = 1.25ms * N  */
#define VIC_SOFT_INTR_ISR_INDEX        (VIC_PWM3_ISR_INDEX)
