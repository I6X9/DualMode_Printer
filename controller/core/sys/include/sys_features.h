...
#define PRH_BS_CFG_LMP_SUBVERSION     0x2000
...
#if 0//def CONFIG_TWS  
	#define PRH_BS_CFG_SYS_SIZEOF_LMP_OUT_HEAP	   0x180  /* Bytes	*/
    #define PRH_BS_CFG_SYS_MAX_LMP_OUT_MESSAGES    (12 + 12)
#else
	#define PRH_BS_CFG_SYS_SIZEOF_LMP_OUT_HEAP	   0x100  /* Bytes	*/
//#define PRH_BS_CFG_SYS_MAX_LMP_OUT_MESSAGES	 12
	#define PRH_BS_CFG_SYS_MAX_LMP_OUT_MESSAGES    (12 + 6)
#endif
...
#else
    #ifdef CONFIG_TWS  // 增大缓存，距离会好
    #define PRH_BS_CFG_SYS_NUM_IN_ACL_PACKETS      (8 + 8)    /* Buffers*/
    #define PRH_BS_CFG_SYS_NUM_OUT_ACL_PACKETS     (8 + 8)     /* Buffers*/
    #else
...
#else
    #define PRH_BS_CFG_SYS_NUM_IN_SCO_PACKETS      4    /* Buffers*/
    #define PRH_BS_CFG_SYS_NUM_OUT_SCO_PACKETS     4    /* Buffers*/
#endif
#endif
...
/*****   URAM reduce  ***/
    ...
    #define PRH_MAX_DEVICES_SUPPORTED                     4 // 4:2*acl+2sco
#elif ( BT_MODE==BT_MODE_TWS)
    #define PRH_MAX_DEVICES_SUPPORTED                     3 // 3:acl+sco+slave 
#else
    #define PRH_MAX_DEVICES_SUPPORTED                     2 // 2:acl+sco 
#endif
#endif
/************************/
#if ( BT_MODE==BT_MODE_1V2)
    #define PRH_BS_CFG_SYS_MAX_ACTIVE_DEVICES_PICONET     4 // 4:2*acl+2sco
#elif ( BT_MODE==BT_MODE_TWS)
    #define PRH_BS_CFG_SYS_MAX_ACTIVE_DEVICES_PICONET     3 // 3:acl+sco+slave 
#else
    #define PRH_BS_CFG_SYS_MAX_ACTIVE_DEVICES_PICONET     2 // 2:acl+sco 
#endif
...
#endif
#define ACL_LONG_PKT_FEC_MODE               0
#define READ_RMT_RSSI_FROM_UART                  0
