...
#define PRH_DEFAULT_PAGE_TIMEOUT            0x2000  // 3s  //0x2000   /* 5.12 Seconds */
#ifdef CONFIG_TWS
#if(PRH_BS_CFG_SYS_HCI_V12_FUNCTIONALITY_SUPPORTED==1)
#define DEFAULT_INQUIRY_SCAN_INTERVAL       0x0400   /* 2.56 Seconds  0x1000 */
#else
#define DEFAULT_INQUIRY_SCAN_INTERVAL       0x0400   /* 1.28 Seconds  0x0800 */
#endif
#define DEFAULT_INQUIRY_SCAN_WINDOW         0x0024   /* 11.25 ms == 18 slots */
#else
#if(PRH_BS_CFG_SYS_HCI_V12_FUNCTIONALITY_SUPPORTED==1)
