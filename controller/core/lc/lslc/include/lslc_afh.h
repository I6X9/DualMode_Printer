 ...
 * AFH parameters
 */
#define AFH_N_MIN_USED_CHANNELS_MST     20
...
extern const u_int8 _LMafh_bad_channel_bit_vector[AFH_BYTES_PER_CHANNEL_MAP];
#define mLSLCafh_Get_Bad_Bit_Vector_Set_Ref()   (_LMafh_bad_channel_bit_vector)
