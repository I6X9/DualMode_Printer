...
#define HCI_BEKEN_DEFINED_EVENT                            0x25
...
#endif
#ifdef CONFIG_TWS
#define EIR_TYPE_FLAGS              0x01 /* flags */
#define EIR_TYPE_UUID16_PART        0x02 /* 16-bit UUID, more available */
#define EIR_TYPE_UUID16_ALL         0x03 /* 16-bit UUID, all listed */
#define EIR_TYPE_UUID32_PART        0x04 /* 32-bit UUID, more available */
#define EIR_TYPE_UUID32_ALL         0x05 /* 32-bit UUID, all listed */
#define EIR_TYPE_UUID128_PART       0x06 /* 128-bit UUID, more available */
#define EIR_TYPE_UUID128_ALL        0x07 /* 128-bit UUID, all listed */
#define EIR_TYPE_NAME_SHORTENED     0x08 /* shortened local name */
#define EIR_TYPE_NAME_COMPLETE      0x09 /* complete local name */
#define EIR_TYPE_TX_POWER_LEVEL     0x0A /* transmit power level */
#define EIR_TYPE_MANUFACTURER_DATA  0xFF /* Manufacturer Specific Data */
#endif
/*
