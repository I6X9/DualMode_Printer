...
typedef struct q_desc 
{
    ...
    u_int8 q_flag;                   /**< aligned(4), Vendor private flag: bit0 = 1 means it's TWS SCO data, bit1~bit7 reserved. */
} t_q_descr;
#ifdef CONFIG_TWS
#define Q_FLAG_TWS_SCO_DATA                     (0x01UL << 0)  /*  bit0 = 1 means it's TWS SCO data. */ 
#endif
