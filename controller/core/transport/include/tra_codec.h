...
#if TWS_HFP_ENABLE
void TRAcodec_alaw_encoder(int16_t *pcm,int16_t smpl_len);
void TRA_codec_alaw_decoder(uint8_t *alaw,int16_t *smpl,int16_t smpl_len);
void *TRAcodec_get_sbc_codec_ptr(void);
#endif
